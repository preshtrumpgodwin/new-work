<?php
/**
 * Zetaphase EduCloud — Admin Dashboard Entry Point
 *
 * Thin wrapper: shared session/schema/feature-flag/data-hoisting logic now
 * lives in lib/dashboard-bootstrap.php (shared with staff/index.php so the
 * two entry points can never drift apart). This file owns the ADMIN-specific
 * HTML shell — admin header/sidebar and the section content include.
 */
define('ADMIN_DIR', __DIR__);
require_once __DIR__ . '/lib/dashboard-bootstrap.php';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo htmlspecialchars($school['name'] ?? 'School Dashboard'); ?> — Admin Dashboard</title>
